                  ...
                  <div class="row">
                     <div class="col-xl-4 col-lg-3 col-md-4 col-sm-6">
                        <div class="tp-footer-widget footer-col-1 mb-50">
                           <div class="tp-footer-widget-content">
                              ...
                              <p class="tp-footer-desc">Explore the latest gadgets, tech accessories, and electronics. Cutting-edge technology delivered to your doorstep</p>
                        ...
                        <div class="tp-footer-widget footer-col-2 mb-50">
                           ...
                           <div class="tp-footer-widget-content">
                              <ul>
                                 ...
                                 <li><a href="cart">Order History</a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
                     <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        <div class="tp-footer-widget footer-col-3 mb-50">
                           ...
                           <div class="tp-footer-widget-content">
                              <ul>
                                 <li><a href="home/our_story">Our Story</a></li>
                                 <li><a href="home/privacy_policy">Privacy Policy</a></li>
                                 <li><a href="home/terms">Terms & Conditions</a></li>
                                 <li><a href="home/letest_news">Latest News</a></li>
                        ...
                        <div class="tp-footer-widget footer-col-4 mb-50">
                           ...
                           <div class="tp-footer-widget-content">
                              <div class="tp-footer-talk mb-20">
                                 ...
                                 <h4><a href="tel:670-413-90-762">+91 9838078783</a></h4>
                              </div>
                              <div class="tp-footer-contact">
                                 <div class="tp-footer-contact-item d-flex align-items-start">
                                    ...
                                    <div class="tp-footer-contact-content">
                                       <p><a href="email: nadimahmad630@gmail.com">nadimahmad630@gmail.com</span></a></p>
                                    </div>
                                 </div>
                                 <div class="tp-footer-contact-item d-flex align-items-start">
                                    <div class="tp-footer-contact-icon">
                                    ...
                                    <div class="tp-footer-contact-content">
                                       <p><a href="https://www.google.com/maps/place/Sleepy+Hollow+Rd,+Gouverneur,+NY+13642,+USA/@44.3304966,-75.4552367,17z/data=!3m1!4b1!4m6!3m5!1s0x4cccddac8972c5eb:0x56286024afff537a!8m2!3d44.3304928!4d-75.453048!16s%2Fg%2F1tdsjdj4" target="_blank">Mohanganj, Tiloi. <br> Amethi, Uttar Pradesh</a></p>
                                    </div>
                                 </div>
                              </div>
                           </div>
                     ...
                     <div class="row align-items-center">
                        <div class="col-md-6">
                           <div class="tp-footer-copyright">
                              <p>© <?=date('Y')?> All Rights Reserved  |  Nadim Ahmad.</p>
                           </div>
                        </div>
                        <div class="col-md-6">
