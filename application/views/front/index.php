                        ...
                        <div class="row align-items-center">
                           <div class="col-xl-5 col-lg-6 col-md-6">
                              <div class="tp-slider-content p-relative z-index-1">
                                 ...
                                 <h3 class="tp-slider-title">The best tablet Collection <?=date('Y')?></h3>
                                 <p>Exclusive offer 
                                    <span>-35% 
                                 ...
                                 <div class="tp-slider-btn">
                                    <a href="#all-products" class="tp-btn tp-btn-2 tp-btn-white">Shop Now
                           ...
                           <div class="col-xl-7 col-lg-6 col-md-6">
                              <div class="tp-slider-thumb text-end">
                                 <img src="images/banner_img/<?=$r->banner_image;?>" alt="slider-img">
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="tp-product-category-item text-center mb-40">
                        <div class="tp-product-category-thumb fix">
                           <a href="shop-category.html">
                              <img src="images/category_img/<?=$r->cat_image?>" alt="product-category">
                           </a>
                        </div>
                        <div class="tp-product-category-content">
                           <h3 class="tp-product-category-title">
                              <a href="images/category_img/<?=$r->cat_image?>"><?=$r->cat_name?></a>
                           </h3>
                           <p>20 Product</p>
                        </div>
                     </div>
         ...
         <section class="tp-product-area pb-55">
            <div class="container">
               <div class="row align-items-end">
                  ...
                  <div class="col-xl-7 col-lg-6 col-md-7" id="all-products">
                                    ...
                                    <div class="tp-product-item p-relative transition-3 mb-25">
                                       <div class="tp-product-thumb p-relative fix m-img">
                                          <a href="product/<?=$r->slug?>">
                                             <img src="images/product_img/<?=$r->pro_main_image?>" alt="product-electronic">
                                          </a>
                                       </div>
                                       <!-- product content -->
                                       <div class="tp-product-content">
                                          <div class="tp-product-category">
                                             <?php $cat_name = $this->Home->get_product_cat($r->cat);?>
                                             <a href="product/<?=$r->slug?>"><?=$cat_name?></a>
                                          </div>
                                          ...
                                          <div class="tp-product-price-wrapper">
                                             <span class="tp-product-price old-price">₹<?=number_format($r->mrp)?></span>
                                             <span class="tp-product-price new-price">₹<?=number_format($r->selling_price)?></span>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
