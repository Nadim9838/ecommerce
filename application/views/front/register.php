         ...
         <div class="col-xl-6 col-lg-8">
            ...
            <div class="tp-login-wrapper">
               <div class="tp-login-top text-center mb-30">
                  <p>Already have an account?  <span><a href="user/">Sign In</a></span></p>
               </div>
               <div class="tp-login-option">
                  ...
                  <div class="tp-login-input-wrapper">
                     <div class="tp-login-input-box">
                        <div class="tp-login-input">
                           <input id="name" name="name" value="<?=set_value('name')?>" type="text" placeholder="Enter full name">
                           <?=form_error('name')?>
                        </div>
                     ...
                     <div class="tp-login-input-box">
                        <div class="tp-login-input">
                           <input id="email" name="email" value="<?=set_value('email')?>" type="email" placeholder="Enter your email">
                           <?=form_error('email')?>
                        </div>
                        <div class="tp-login-input-title">
                     ...
                     <div class="tp-login-input-box">
                        <div class="tp-login-input">
                           <input id="tp_password" name="password" value="<?=set_value('password')?>" type="password" placeholder="Min. 6 character">
                           <?=form_error('password')?>
                        </div>
                  ...
                  <div class="tp-login-suggetions d-sm-flex align-items-center justify-content-between mb-20">
                     <div class="tp-login-remeber">
                        <input id="remeber" checked  name="terms" type="checkbox" value="agree">
                        <label for="remeber">I accept the terms of the Service & <a href="user/policy">Privacy Policy</a>.</label>
                        <?=form_error('terms')?>
                     </div>
                  </div>
