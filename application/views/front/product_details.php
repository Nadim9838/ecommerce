                  ...
                  <div class="row">
                           ...
                           <div class="tab-content m-img" id="productDetailsNavContent">
                              <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1-tab" tabindex="0">
                                 <div class="tp-product-details-nav-main-thumb">
                                    <img src="images/product_img/<?=$r->pro_main_image?>" alt="" height="600" width="600">
                                 </div>
                              </div>
                            </div>
                        </div>
                     ...
                     <div class="col-xl-5 col-lg-6">
                        <div class="tp-product-details-wrapper">
                           ...
                           <h3 class="tp-product-details-title"><?=$r->product_name?></h3>
                           ...
                           <p><?=$r->highlights?><span>See more</span></p>
   
                           <!-- price -->
                           <div class="tp-product-details-price-wrapper mb-20">
                              <span class="tp-product-details-price old-price"><?=number_format($r->mrp)?></span>
                              <span class="tp-product-details-price new-price"><?=number_format($r->selling_price)?></span>
                           </div>
