               ...
               <div class="row">
                  <div class="col-xxl-12">
                     <div class="breadcrumb__content p-relative z-index-1">
                        <h3 class="breadcrumb__title">Login Here</h3>
                ...
                ?>
                     <div class="tp-login-wrapper">
                        <div class="tp-login-top text-center mb-30">
                           ...
                           <p>Don’t have an account? <span><a href="user/register">Create a free account</a></span></p>
                        </div>
                           ...
                           <div class="tp-login-input-wrapper">
                              <div class="tp-login-input-box">
                                 <div class="tp-login-input">
                                    <input name="email" value="<?=set_value('email')?>" id="email" type="email" placeholder="Enter email">
                                    <?=form_error('email')?>
                                 </div>
                              ...
                              <div class="tp-login-input-box">
                                 <div class="tp-login-input">
                                    <input name="password" value="<?=set_value('password')?>" id="tp_password" type="password" placeholder="Enter password">
                                    <?=form_error('password')?>
                                 </div>
