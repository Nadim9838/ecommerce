            <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-6">
                                <script>document.write(new Date().getFullYear())</script> © Shofy.
                            </div>
                            <div class="col-sm-6">
                                <div class="text-sm-end d-none d-sm-block">
                                    Crafted with <i class="mdi mdi-heart text-danger"></i> by Nadim Ahmad
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
    function get_categories(cat_id) {
        $.ajax({
            url: '<?=base_url('category/get_sub_category')?>',
            type: 'post',
            data: {cat_id:cat_id},
